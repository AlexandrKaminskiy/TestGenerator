...
namespace Analyser
{
    ...
    {
        public static List<GeneratedValuesInfo.FileInfo> Generate(List<NsInfo> nsInfo, List<UsingDirectiveSyntax> usings)
        {
            var result = new List<GeneratedValuesInfo.FileInfo>();
